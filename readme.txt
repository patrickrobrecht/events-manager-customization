...
Customize the Events Manager booking form for every event.

== Description ==

This plugin allows to customize the [Events Manager](https://wordpress.org/plugins/events-manager/) booking form using two additional options, which can be set for every event:
